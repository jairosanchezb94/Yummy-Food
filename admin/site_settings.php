<?php
include 'db_connect.php'; $qry = $conn->query("SELECT * from system_settings limit 1");
if($qry->num_rows > 0){
	...
	<div class="card col-lg-12">
		<div class="card-body">
			<form action="" id="manage-settings">
				...
				<div class="form-group">
					<label for="about" class="control-label">Sobre el contacto</label>
				...
				<center><button class="btn btn-info btn-primary btn-block col-md-2">Guardar</button></center>
			</form>
		</div>
	</div>
	<style>
