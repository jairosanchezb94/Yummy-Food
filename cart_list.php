 <!-- Tope -->
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white"> Lista del carrito</h3>
        	...
        	<div class="col-lg-8">
        		<div class="sticky">
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				<div class="col-md-8"><b>Carro</b></div>
        			...
        			<div class="card">
        				<div class="card-body">
        					...
        					<div class="text-center">
        						<button class="btn btn-block btn-outline-primary" type="button" id="checkout"> Pasar por la caja </button>
        					</div>
        				</div>
        			</div>
        		</div>
    ...
    <script>
        ...
        $('.view_prod').click(function(){
            uni_modal_right('Producto','view_prod.php?id='+$(this).attr('data-id'))
        })
